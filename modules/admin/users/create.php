 <!-- File: modules/admin/users/create.php -->
<?php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($check_stmt->fetchColumn() > 0) {
        ...
        if ($stmt->execute([$username, $email, $password, $nama_lengkap, $role, $no_telepon, $alamat])) {
            setMessage('success', 'Pengguna berhasil ditambahkan!');
            redirect('/modules/admin/users/index.php');
        } else {
            setMessage('danger', 'Gagal menambahkan pengguna!');
        }
    }
}
?>
