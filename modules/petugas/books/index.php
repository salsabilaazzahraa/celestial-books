                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <a href="edit.php?id=<?= $book['id'] ?>" class="btn btn-warning text-white" data-bs-toggle="tooltip" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="delete.php?id=<?= $book['id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus buku ini?')" data-bs-toggle="tooltip" title="Hapus">
